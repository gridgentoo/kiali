[![Watch the video](https://img.youtube.com/vi/T-D1KVIuvjA/maxresdefault.jpg)](https://www.youtube.com/watch?v=NkJgtYvZ_oE)  
[16 нояб. 2021 ] Kiali Sprint 65 Demo [v1.43] - Service mesh management for Istio.  

  
[AuthorizationPolicy, Алгоритм валидации] Политики авторизации [models.IstioCheck]&[kubernetes.IstioObjecat]&[models.Namespaces]
https://docs.google.com/document/d/1J9WTrGnEXNyoevwk_yRM1LlA3STGuuW-RF2SJQuGxlc/

models.IstioCheck - это типо ООП Последовательность валидации в коде Kiali - ОПЕРАТОРА KIALI & ISTIO 
// Проверьте ServiceEntries 
// В противном случае проверьте VirtualServices 
Исходный код 
https://github.com/kiali/kiali/blob/master/business/checkers/authorization/no_host_checker.go 
